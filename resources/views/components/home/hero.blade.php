...
<div class="relative pt-[60px] lg:pt-[80px] pb-[110px] bg-white dark:bg-slate-800">
    <div class="container">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    <h1 class="text-dark dark:text-gray-200 font-bold text-4xl sm:text-[42px] lg:text-[40px] xl:text-[42px] leading-snug mb-6">
                        My Name Is M.Salah. <br/>
                        I am <span class="rounded-md text-amber-500">AppBuilder</span>.
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        I am a developer with 3+ years of experience. <br/>
                        I love building creative web sites and applications that satisfy my clients requirements
                    </p>
            ...
            <div class="hidden lg:block lg:w-7/12 px-4">
                <div class="w-full px-4">
                    <div class="lg:text-right lg:ml-auto">
                        <div class="relative inline-block z-10 pt-11 lg:pt-0">
                            <img src="{{asset('image/svg/Attribution-modeling.svg')}}" alt="hero" class="max-w-full lg:ml-auto">
